                    ...
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    <li>Welcome to Bukunmi Project <a href="{{route('shop')}}">View details</a></li>
                                    <li>Bukunmi is a PHP/Python web developer </li>
                                    <li> Check out the shopping cart  <a href="{{route('shop')}}">Shop now</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Toll Free</span> (+234) 7068-088-124 </p>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong> Akure Oyemekun Road
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+234 7068-088-124
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>contact@bukunmi.com
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">Bukunmi</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
