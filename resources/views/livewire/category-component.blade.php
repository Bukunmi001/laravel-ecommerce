                                ...
                                <div class="sort-by-cover mr-10">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{$pageSize == 15 ? 'active': ''}}" wire:click.prevent="changePageSize(15)">15</a></li>
                                            <li><a class="{{$pageSize == 25 ? 'active': ''}}" wire:click.prevent="changePageSize(25)">25</a></li>
                                            <li><a class="{{$pageSize == 32 ? 'active': ''}}" wire:click.prevent="changePageSize(32)">32</a></li>
