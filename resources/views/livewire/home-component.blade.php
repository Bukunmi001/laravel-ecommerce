                                ...
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="{{route('product.details', ['slug'=>$fproduct->slug]) }}">Clothing</a>
                                        </div>
                ...
                <div class="carausel-6-columns-cover position-relative">
                    ...
                    <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                        ...
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="{{route('product.details', ['slug'=>$product_1->slug]) }}">
                                        <img class="default-img" src="{{ asset('assets/imgs/products')}}/{{$product_1->image}}" alt="{{$product_1->name}}">
                            ...
                            <div class="product-content-wrap">
                                <h2><a href="product-details.html">{{$product_1->name}}</a></h2>
                                <div class="rating-result" title="90%">
                                    <span>
                                    </span>
                                </div>
                                <div class="product-price">
                                    <span>${{$product_1->regular_price }} </span>
                                    <!-- <span class="old-price">$245.8</span> -->
                                </div>
                            </div>
                        </div>
