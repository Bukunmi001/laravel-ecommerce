                                ...
                                <form wire:submit.prevent="updateSlide">
                                    <div class="mb-3 mt-3">
                                     ...
                                     <div class="mb-3 mt-3">
                                        ...
                                        <input type="text"  class="form-control" placeholder="Enter slide top title"  wire:model="title"  />
                                        @error('title')
                                        <p class="text-danger"> {{$message}} </p>
                                        @enderror
                                    </div>
                                     <div class="mb-3 mt-3">
                                        ...
                                        <input type="text"  class="form-control" placeholder="Enter slide sub title" wire:model="subtitle" />
                                         @error('subtitle')
                                        <p class="text-danger"> {{$message}} </p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        @else 
                                            <img src="{{asset ('asset/imgs/slider')}}/{{$image}}" width="100" />
